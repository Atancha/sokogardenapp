...
const Signin = () => {
  ...
  const handlesubmit = async(e) =>{
    ...
    try{
      //create a formData object that hold the email and the password
      ...
      const response = await axios.post("https://mwikalii.alwaysdata.net/api/signin", formdata);
...
//how can you store the users details into the localstorageno