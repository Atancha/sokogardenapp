...
const Makepayment = () => {
    ...
    //The useLocation hook allows us to get/destructures the properties passed from the previous component.
        ...
        <div className="row justify-content-center">
            ...
            <div className="col-md-6 card shadow p-4">
                ...
                <div className="card-body">
                    ...
                    <b className="text-warning">{product.product_cost}</b> <br /><br />
