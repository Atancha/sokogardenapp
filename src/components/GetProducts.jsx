...
const GetProducts = () => {
  ...
  const img_url = "https://mwikalii.alwaysdata.net/static/images/"
  ...
  const fetchProducts = async() =>{
    try{
      ...
      const response = await axios.get("https://mwikalii.alwaysdata.net/api/get_products")
  ...
  //we shall sue the useEffect hook.This hook enables to automatically re-render new features incase of any changes.
  useEffect(() => {
    fetchProducts()
  },[])
