...
const Addproducts = () => {
  ...
  //Declare the addtional hook to manage the state of the application
  ...
  const handleSubmit = async (e) =>{
    ...
    try{
      ...
      const response = await axios.post("https://mwikalii.alwaysdata.net/api/add_product",formdata)
